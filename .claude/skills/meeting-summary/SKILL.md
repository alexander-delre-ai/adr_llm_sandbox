...
- **Inline text**: Paste the transcript in the same message as the request.
...
6. **Create analysis**: Read and follow `.claude/skills/meeting-analysis/SKILL.md`. Use the full text of `transcript.md` as meeting content and the workspace directory as the output location. Produce `analysis.md` with the standard six sections.
