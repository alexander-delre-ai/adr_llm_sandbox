...
Edit `.cursor/skills/ticktick-sync/.env` to customize:
...
bash .cursor/skills/daily-todos/scripts/generate_todos.sh 2026-03-15 --sync-ticktick
```
...
python3 .cursor/skills/ticktick-sync/scripts/sync_todos.py --dry-run
```
...
**Solution**: 
1. Run `python3 .cursor/skills/ticktick-sync/scripts/auth_setup.py`
...
3. Run daily-todos generation first: `bash .cursor/skills/daily-todos/scripts/generate_todos.sh`
